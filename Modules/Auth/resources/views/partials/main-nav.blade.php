<div class="main-nav clearfix">
    <div class="container">
        <div class="row">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="post-block-style clearfix">
                                                    <div class="post-thumb">
                                                        <img class="img-responsive"
                                                             src="{{ asset('home/images/news/video/video4.jpg') }}" alt="">
                                                        <a class="popup"
                                            ...
                                            <div class="col-md-3">
                                                <div class="post-block-style clearfix">
                                                    <div class="post-thumb">
                                                        <img class="img-responsive"
                                                             src="{{ asset('home/images/news/video/video3.jpg') }}" alt="">
                                                        <a class="popup"
                                            ...
                                            <div class="col-md-3">
                                                <div class="post-block-style clearfix">
                                                    <div class="post-thumb">
                                                        <img class="img-responsive"
                                                             src="{{ asset('home/images/news/video/video2.jpg') }}" alt="">
                                                        <a class="popup"
                                            ...
                                            <div class="col-md-3">
                                                <div class="post-block-style clearfix">
                                                    <div class="post-thumb">
                                                        <img class="img-responsive"
                                                             src="{{ asset('home/images/news/video/video1.jpg') }}" alt="">
                                                        <a class="popup"
                                                           href="https://www.youtube.com/embed/DQNDcxRo-2M?autoplay=1&amp;loop=1">
                                                            <div class="video-icon">
                                                                <i class="fa fa-play"></i>
            ...
            <div class="nav-login">
                <a href="#" id="login"><i class="fa fa-user-plus"></i></a>
            </div><!-- Search end -->
            <div class="nav-register">
                <a href="#" id="register"><i class="fa fa-user"></i></a>
            </div><!-- Search end -->
